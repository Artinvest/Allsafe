...
In order to support loading of multiple wallets in allsafe-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is allsafe.cpp.
...
Changes to allsafe.cpp
----------------------
allsafe.cpp is the entry point into allsafe-qt, and as such, will require some minor modifications to provide hooks for
