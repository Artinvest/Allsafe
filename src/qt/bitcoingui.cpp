                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("AllSafe Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a AllSafe address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and allsafe: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About AllSafe Core"), this);
    aboutAction->setStatusTip(tr("Show information about AllSafe Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for AllSafe"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your AllSafe addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified AllSafe addresses"));
    ...
    openAction->setStatusTip(tr("Open a AllSafe: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the AllSafe Core help message to get a list with possible AllSafe command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("AllSafe Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("AllSafe Core"); // default title
...
/** Creates context menu, its actions, and allsafes up all the relevant signals for mouse events. */
