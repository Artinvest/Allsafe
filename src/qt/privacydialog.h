...
public:
    ...
    void setZAllSafeControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzSAFE_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzSAFE_clicked();
    void on_pushButtonZAllSafeControl_clicked();
