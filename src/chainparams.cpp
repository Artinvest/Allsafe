...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x000008ef7624feb09776d000c2cfcf670caa04e029ba16b88fbde2a0bdfd047b"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1545874509, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("049dac032d04477b5ff9df6fa17185732af9439ccded831664ea5dc0aeff7d2126103416acedd6d380a3010f14046bbb94ab64d4b2cfa2ab5dadec21c144041514");
        nDefaultPort = 7127;
        bnProofOfWorkLimit = ~uint256(0) >> 20; //20 AllSafe starting difficulty is 1 / 2^12
        ...
        nZerocoinStartTime = 1745874509;
        nBlockEnforceSerialRange = 1; //Enforce serial range starting this block
        nBlockRecalculateAccumulators = ~1; //Trigger a recalculation of accumulators
        nBlockFirstFraudulent = ~1; //First block that bad serials emerged
        nBlockLastGoodCheckpoint = ~1; //Last valid accumulator checkpoint
        const char* pszTimestamp = "AllSafe Version 2 Established Dec 2018 - Merry Christmas & Happy New Year";
        CMutableTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CScriptNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 1 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04fda9440cc8a4a0ba774135eeb1039ba7420d72142d99a54858573a726cf86bfba8cc0e554d5b5d6ea650c3badf832f54521d3ec2648e30bf1784a66c5fb92266") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime = 1545874509;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 262373;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x000008ef7624feb09776d000c2cfcf670caa04e029ba16b88fbde2a0bdfd047b"));
        assert(genesis.hashMerkleRoot == uint256("0x5d7df006b8fa32dbd25c7ecfebff4278159c4ada47c32592699dc13a36802d9d"));

	vSeeds.push_back(CDNSSeedData("185.241.54.17", "185.241.54.17"));
        vSeeds.push_back(CDNSSeedData("185.241.54.37", "185.241.54.37"));
        vSeeds.push_back(CDNSSeedData("185.241.54.45", "185.241.54.45"));
	...
	strSporkKey = "048600B38F5EAA95A3A70B3E7FAE76B2392A1C5F6926B361A5B531FD2C0270598616CA2B9540B6125B93B4D7C0CFFB1BABD7E3C57490E929280A312F216618D340";
        strObfuscationPoolDummyAddress = "sfSAthmZqvsay3mduUi29Dfb6qPeoUPDJN";
        nStartMasternodePayments = 1545874509;
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // AllSafe: 1 day
        nTargetSpacing = 1 * 60;  // AllSafe: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet allsafe addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet allsafe script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet allsafe BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet allsafe BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet allsafe BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // AllSafe: 1 day
        nTargetSpacing = 1 * 60;        // AllSafe: 1 minutes
