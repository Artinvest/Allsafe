...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("AllSafe Core allsafe-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  allsafe-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded allsafe transaction") + "\n" +
                               "  allsafe-tx [options] -create [commands]   " + _("Create hex-encoded allsafe transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded allsafe transaction
