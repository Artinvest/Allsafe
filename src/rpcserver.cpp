...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* AllSafe features */
        {"allsafe", "masternode", &masternode, true, true, false},
        {"allsafe", "listmasternodes", &listmasternodes, true, true, false},
        {"allsafe", "getmasternodecount", &getmasternodecount, true, true, false},
        {"allsafe", "masternodeconnect", &masternodeconnect, true, true, false},
        {"allsafe", "masternodecurrent", &masternodecurrent, true, true, false},
        {"allsafe", "masternodedebug", &masternodedebug, true, true, false},
        {"allsafe", "startmasternode", &startmasternode, true, true, false},
        {"allsafe", "createmasternodekey", &createmasternodekey, true, true, false},
        {"allsafe", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"allsafe", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"allsafe", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"allsafe", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"allsafe", "getmasternodescores", &getmasternodescores, true, true, false},
        {"allsafe", "mnbudget", &mnbudget, true, true, false},
        {"allsafe", "preparebudget", &preparebudget, true, true, false},
        {"allsafe", "submitbudget", &submitbudget, true, true, false},
        {"allsafe", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"allsafe", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"allsafe", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"allsafe", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"allsafe", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"allsafe", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"allsafe", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"allsafe", "checkbudgets", &checkbudgets, true, true, false},
        {"allsafe", "mnsync", &mnsync, true, true, false},
        {"allsafe", "spork", &spork, true, true, false},
        {"allsafe", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"allsafe", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use allsafed, or the -server option to allsafe-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> allsafe-cli " + methodname + " " + args + "\n";
}
