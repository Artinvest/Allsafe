...
RESOURCES += src/qt/allsafe.qrc src/qt/allsafe_locale.qrc

TRANSLATIONS += src/qt/locale/allsafe_bg.ts \
                src/qt/locale/allsafe_de.ts \
                src/qt/locale/allsafe_en.ts \
                src/qt/locale/allsafe_es.ts \
                src/qt/locale/allsafe_fi.ts \
                src/qt/locale/allsafe_fr.ts \
                src/qt/locale/allsafe_it.ts \
                src/qt/locale/allsafe_ja.ts \
                src/qt/locale/allsafe_pl.ts \
                src/qt/locale/allsafe_pt.ts \
                src/qt/locale/allsafe_ru.ts \
                src/qt/locale/allsafe_sk.ts \
                src/qt/locale/allsafe_sv.ts \
                src/qt/locale/allsafe_vi.ts \
                src/qt/locale/allsafe_zh_CN.ts \
                src/qt/locale/allsafe_zh_TW.ts
