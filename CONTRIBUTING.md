Contributing to AllSafe Core
============================

The AllSafe Core project operates an open contributor model where anyone is
...
The following applies to code changes to the AllSafe Core project, and is not to be
confused with overall AllSafe Network Protocol consensus changes.

Whether a pull request is merged into AllSafe Core rests with the project merge
...
Patches that change AllSafe consensus rules are considerably more involved than
...
Where a patch set proposes to change the AllSafe consensus, it must have been
...
The project leader is the release manager for each AllSafe Core release.
